...
public class EditProfilMahasiswa extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progdi = (TextView) findViewById(R.id.progdi);
    ...
    private void getMahasiswaData() {
        ...
        api.apiambildataakademikmahassiswa(
                ...
                new Callback<CDataAkademikMahasiswa>() {
                    @Override
                    public void success(CDataAkademikMahasiswa data, Response response) {
                        int size = data.getDataAkademikMahasiswa().size();
                        stremail = data.getDataAkademikMahasiswa().get(size-1).getemail();
                        strusername = data.getDataAkademikMahasiswa().get(size-1).getusername();
                        strprogdi = data.getDataAkademikMahasiswa().get(size-1).getprogramstudi();
                        email.setText(stremail);
                        username.setText(strusername);
                        progdi.setText(strprogdi);
                        Log.d("CEK DATA","email = "+stremail);
                    ...
                    public void failure(RetrofitError error) {
                        ...
                        Toast.makeText(EditProfilMahasiswa.this, "Kesalahan Koneksi Data"  + merror, Toast.LENGTH_LONG).show();
    ...
    private void UploadFile() {
        EditProfilMahasiswa.UploadTask uploadTask=new EditProfilMahasiswa.UploadTask();
    ...
    private void filePicker(){
        ...
        Toast.makeText(EditProfilMahasiswa.this, "File Picker Call", Toast.LENGTH_SHORT).show();
        //Let's Pick File
    ...
    private void requestPermission(){
        if(ActivityCompat.shouldShowRequestPermissionRationale(EditProfilMahasiswa.this, Manifest.permission.WRITE_EXTERNAL_STORAGE)){
            Toast.makeText(EditProfilMahasiswa.this, "Please Give Permission to Upload File", Toast.LENGTH_SHORT).show();
        }
        else{
            ActivityCompat.requestPermissions(EditProfilMahasiswa.this,new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE},PERMISSION_REQUEST_CODE);
        }
    }

    private boolean checkPermission(){
        int result= ContextCompat.checkSelfPermission(EditProfilMahasiswa.this, Manifest.permission.WRITE_EXTERNAL_STORAGE);
        ...
        switch (requestCode){
            case PERMISSION_REQUEST_CODE:
                if(grantResults.length>0 && grantResults[0]==PackageManager.PERMISSION_GRANTED){
                    Toast.makeText(EditProfilMahasiswa.this, "Permission Successfull", Toast.LENGTH_SHORT).show();
                }
                else{
                    Toast.makeText(EditProfilMahasiswa.this, "Permission Failed", Toast.LENGTH_SHORT).show();
                }
        }
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(requestCode==REQUEST_GALLERY && resultCode== Activity.RESULT_OK){
            ...
            file_pathurl=getRealPathFromUri(data.getData(), EditProfilMahasiswa.this);
            ...
            Toast.makeText(EditProfilMahasiswa.this, foto_profil, Toast.LENGTH_LONG).show();
...
//            file_name.setText(file.getName());
            if(file_pathurl!=null){
                ...
                Toast.makeText(EditProfilMahasiswa.this, "Please Select File First", Toast.LENGTH_SHORT).show();
            }
        }
    }
    ...
    public class UploadTask extends AsyncTask<String,String,String> {
        ...
        protected void onPostExecute(String s) {
            ...
            if(s.equalsIgnoreCase("true")){
                Toast.makeText(EditProfilMahasiswa.this, "File uploaded", Toast.LENGTH_SHORT).show();
            }
            else{
                Toast.makeText(EditProfilMahasiswa.this, "Failed Upload", Toast.LENGTH_SHORT).show();
            }
        }
